...
GrantPermissions="GRANT SELECT ON TABLE public.embalagem TO $user;
GRANT SELECT ON TABLE public.cadernooferta TO $user;
GRANT SELECT ON TABLE public.itemcadernooferta TO $user;"

QueryTeste="SELECT * FROM embalagem LIMIT 1;"
