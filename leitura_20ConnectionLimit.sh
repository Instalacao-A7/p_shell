...
CreateRole="CREATE ROLE $user login password '$password' nosuperuser inherit nocreatedb nocreaterole connection limit 20;"
...
echo "ESTE USUÁRIO POSSUI UM LIMITE DE 20 CONEXÕES SIMULTÂNEAS!"
echo ""
echo "#########################################################"
echo ""
